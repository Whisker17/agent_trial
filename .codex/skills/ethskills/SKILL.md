---
name: ethskills
description: Use when tasks involve Ethereum/onchain architecture, tooling, standards, gas costs, wallets, L2s, security, and agent-related protocols.
---

# ETHSKILLS (Cursor -> Codex)

This skill is synced from `.cursor/skills/ethskills.md` so Codex can reference the same Ethereum context.
